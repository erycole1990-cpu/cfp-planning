...
const actionLabels: Record<string, string> = {
  ...
  investment_holding_created: "Investment holding added",
  investment_portfolio_created: "Investment portfolio added",
  investment_transaction_recorded: "Investment transaction recorded",
  investment_transaction_reversed: "Investment transaction reversed",
  investment_transfer_recorded: "Investment transfer recorded",
  investment_valuation_recorded: "Investment valuation recorded",
...
const entityLabels: Record<string, string> = {
  ...
  investment_holdings: "Investment holding",
  investment_portfolios: "Investment portfolio",
  investment_transactions: "Investment transaction",
  investment_valuations: "Investment valuation",

...
begin
  ...
  -- Repair the historical first production administrator when that Auth user
  -- exists. Fresh environments may not have it, so schema replay skips this
  -- alignment; first-administrator creation belongs to environment bootstrap.

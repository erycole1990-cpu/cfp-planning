...
CFP-standard financial planning tool for advisor teams to log customer goals, track progress, and coordinate next-step coaching actions from a shared operational dashboard.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "238494215+erycole1990-cpu@users.noreply.github.com"
  git config user.name "erycole1990-cpu"
  ```
